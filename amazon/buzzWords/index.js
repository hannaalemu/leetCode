...
function findToy(quotes, toys, topToys, numToys) {
  ...
  let quotes = [
  "Elzo is the hottest of the season! Elzo will be on every kid's wishlist!",
  "The new Elzo dolls are super high quality",
  "Expect the Elsa dolls to be very popular this year, Elsa!",
  "Elsa and Elzo are the toys I'll be buying for my kids, Elsa is good",
  "For parents of older kids, look into buying them a drone",
  "Warcraft is slowly rising in popularity ahead of the holiday season"
  ];
  
  let toys = ["elzo", "elsa", "legos", "drone", "tablet", "warcraft"]
